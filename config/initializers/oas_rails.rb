...
OasRails.configure do |config|
  ...
  config.info.description = "Documentación interactiva de mi API"
  config.info.contact.name = "Sebastián Agudelo"
  config.info.contact.email = "miemail@example.com"
  ...
  config.info.description = <<~HEREDOC
    ...
    To customize and enrich yo  ur API documentation:
  ...
  config.servers = [{ url: 'http://192.168.89.195:3000', description: 'Remote' }, { url: 'http://localhost:3000', description: 'Local' }]
